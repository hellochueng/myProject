...
public class PsDaoImpl extends BaseDao implements PsDao {
	...
	public int deletePicture(int id) {
		return  getMapper(PsMapper.class).deletePicture(id);
	}

	@Override
	public int updateAldumName(String name,int id) {
		return getMapper(PsMapper.class).updateAldumName(name, id);
	}

	@Override
	public int deleteAldum(int id, int is_delete) {
		return getMapper(PsMapper.class).deleteAldum(id, is_delete);
	}

	@Override
	public List<imgLog> getAllImgLogByPersonId(int person_id) {
		return getMapper(PsMapper.class).getAllImgLogByPersonId(person_id);
	}
