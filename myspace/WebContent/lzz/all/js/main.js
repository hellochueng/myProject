		...
		success:function(data){
			...
			for(var i =0;i<data.length;i++){
				if(data[i].is_delete==0){
					...
					body+='<dd>'+data[i].name+'</dd><dd>'+data[i].create_time+'</dd><dd><button type="submit" style="height:35px;padding-top:2px;" onclick="deleteLog('+data[i].id+')" class="btn btn-primary btn-lg btn-block">删除</button></dd></dl>';
